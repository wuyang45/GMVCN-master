...
def train(args, datapath, treeLenDic, save_path):
    ...
    train_data_list, eval_data_list, test_data_list = process.loadData(treeLenDic, datapath, args.dropedge, args.lower)
    ...
    torch.save(model.state_dict(),os.path.join(save_path, args.model_name+'-'+str(avg_test_acc)+'-'+str(F1)+'.th'))
...
if __name__ == '__main__':
    ...
    datapath = '/workspace/rumor/task3/data/semeval2017'
    save_path = "/workspace/rumor/task3/output/sem2017/"
    result_save_path = "/workspace/rumor/task3/output/sem2017/result/"
    treeLenDic = treeLen(datapath)
    ...
    for itera in range(args.iterations):
        acc, f1 = train(args, datapath, treeLenDic, save_path)
        all_acc.append(acc)
        all_f1.append(f1)
