...
## Code
Because the preprocessed data is too large, we only submit the source code. In the folder, main_semeval.py and main_pheme.py are the main functions of start training GMVCN on Semeval 2017 and PHEME datasets, respectively.
